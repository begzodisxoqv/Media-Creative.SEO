                            ...
                            <div class="row m-0 py-3">
                                <div class="col-12">
                                    <table class="table table-striped">
                                        ...
                                        <tbody class="result">
                                        @foreach($aboutsus as $about) 
                                            <tr>
                                                <td>{{ $about->title_uz }}</td>
                                                <td>{!! $about->text_uz !!}</td>
                                                <td><img src="{{ asset('storage/' . $about->image) }}" style="width: 100px;" /></td>
                                                <td class="d-flex">
                                                    <a class="text-success mr-2" href="{{ route('aboutsus.edit', $about->id) }}"><i class="nav-icon fas fa-pen font-weight-bold"></i></a>
                                                    <a data-toggle="modal" data-target="#deletesModal{{$about->id}}" class="text-danger mr-2" href="{{ route('aboutsus.destroy', $about->id) }}"><i class="nav-icon far fa-times-circle font-weight-bold"></i></a>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('aboutsus.destroy', $about->id) }}" method="post">
                                                                        @method('DELETE')
                                                                        @csrf
