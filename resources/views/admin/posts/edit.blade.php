    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="breadcrumb">
            ...
            <ul>
                <li><a href="{{ route('posts.index') }}">Все данные</a></li>
            </ul>
        </div>
        </div>
      </div>
                        ...
                        <form action="{{ route('posts.update', $posts->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input class="form-control @error('title_uz') is-invalid @enderror"value="{{ $posts->title_uz }}"
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input class="form-control @error('title_ru') is-invalid @enderror"value="{{ $posts->title_ru }}"
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    <label>text (uz)</label>
                                    <input class="form-control @error('text_uz') is-invalid @enderror"value="{{ $posts->text_uz }}"
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    <label>text (ru)</label>
                                    <input class="form-control @error('text_ru') is-invalid @enderror"value="{{ $posts->text_ru }}"
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    <label>Data (uz)</label>
                                    <input class="form-control @error('data_uz') is-invalid @enderror"value="{{ $posts->data_uz }}"
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    <label>Data (ru)</label>
                                    <input class="form-control @error('data_ru') is-invalid @enderror"value="{{ $posts->data_ru }}"
